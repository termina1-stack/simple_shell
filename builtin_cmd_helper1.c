...
/**
 * display_help - Function that displays help for builtin commands
 * @cmd: Command passed
 * @st: Status of our last executed command
 * Return: 0 Success
 */
...
/**
 * help_unsetenv - Function that displays information by builtin command
 */
